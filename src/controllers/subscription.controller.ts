...
import { type CreateSubscriptionDto, SubscriptionFrequency } from "../models/subscription.model"
...
export class SubscriptionController {
   ...
   */
  async subscribe(
    request: FastifyRequest<{ Body: { email: string; city: string; frequency: string } }>,
    reply: FastifyReply,
  ): Promise<void> {
   ...
   * @param reply Reply object
   */
  async confirmSubscription(request: FastifyRequest<RequestWithToken>, reply: FastifyReply): Promise<void> {
   ...
   * @param reply Reply object
   */
  async unsubscribe(request: FastifyRequest<RequestWithToken>, reply: FastifyReply): Promise<void> {
    const { token } = request.params
